...
#using "here" in posit cloud due to git challenges in RStudio 

surveys <- read_csv(here::here("data", "surveys.csv"))

#surveys <- read_csv(here::here("Week 2", "Lab 2", "lab-2-eleback", "data", "surveys.csv"))
```
